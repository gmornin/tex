...
pub async fn text(
    ...
    Ok((display, "<link href=\"/static/css/textpreview.css\" rel=\"stylesheet\" /><link href=\"/static/css/prism.css\" rel=\"stylesheet\" /><script src=\"/static/scripts/prism.js\"></script>", None))
}
...
pub fn pdf(url: &str, nonce: &str) -> String {
