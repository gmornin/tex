...
const defaultOptions = {
  ...
  cMapUrl: {
    value: "/static/scripts/pdfjs/web/cmaps/",
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  standardFontDataUrl: {
    value: "/static/scripts/pdfjs/web/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: "/static/scripts/pdfjs/build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
...
}
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "/static/scripts/pdfjs/build/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
}
