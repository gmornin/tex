...
function __wbg_adapter_14(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h88e346c869f55beb(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {string}
*/
export function get_value(doc, id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.get_value(retptr, addBorrowedObject(doc), ptr0, len0);
...
* @param {boolean} val
*/
export function disable_buttons(doc, val) {
    try {
        wasm.disable_buttons(addBorrowedObject(doc), val);
    } finally {
        heap[stack_pointer++] = undefined;
    }
}
